...
void main() {
  ...
  test('n=100(100桁)の場合', () {
    expect(no3.findMinPermutation('9455556666556666777999990111333653365553444400000000111122222222223333089111444447777777888888888999'), '1000000000011111111122222222223333333333444444444455555555556666666666777777777788888888889999999999');
  });

  test('制約外', () {
    expect(() => no3.findMinPermutation(''), throwsArgumentError);
    expect(() => no3.findMinPermutation('0' * 101), throwsArgumentError);
  });
}
